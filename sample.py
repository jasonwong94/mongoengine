...
def main():
	...
	deansList = Student.objects()
	for student in deansList:
		printStudentInfo(student)


class AcademicInfo(EmbeddedDocument):
...
class Student(Document):
	...
	#EmbeddedDocuments 
	registrationInfo = EmbeddedDocumentField(RegistrationInfo)
	contactInfo = EmbeddedDocumentField(ContactInfo)
	academicInfo = EmbeddedDocumentField(AcademicInfo)	
